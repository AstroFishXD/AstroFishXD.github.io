...
const contentData = [
  {
    id: "short-001",
    section: "video",
    title: "¿Buscas servidor? Estos son los mejores",
    tag: "java",
    tagLabel: "Vídeo",
    thumbnail: "assets/thumb-generic.png",
    videoUrl: "#",
    description: "Los mejores servidores de Minecraft PVP para jugar.",
    date: "2026-08-18",
    gameVersion: "1.20",
    downloads: [],
  },
  {
    id: "short-002",
    section: "video",
    title: "El mejor clutch de TNT run en Hypixel",
    tag: "java",
    tagLabel: "Vídeo",
    thumbnail: "assets/thumb-generic.png",
    videoUrl: "https://youtube.com/shorts/kLLY1EYSiKI?si=jMhkmXyx360XDfA-",
    description: "Un increíble clutch en TNT run que nadie esperaba.",
    date: "2026-08-17",
    gameVersion: "1.20",
    downloads: [],
  },
  {
    id: "short-003",
    section: "video",
    title: "Un nuevo inicio para AstroFish",
    tag: "java",
    tagLabel: "Vídeo",
    thumbnail: "assets/thumb-generic.png",
    videoUrl: "https://youtube.com/shorts/FZicnqk_JGs?si=4rhtZfRDlFeQAhXQ",
    description: "El comienzo de una nueva etapa en el canal.",
    date: "2026-07-24",
    gameVersion: "1.20",
    downloads: [],
  },
  {
    id: "short-004",
    section: "video",
    title: "Nadie sobrevive a este combo en Bedwars",
    tag: "addon",
    tagLabel: "Vídeo",
    thumbnail: "assets/thumb-generic.png",
    videoUrl: "https://youtube.com/shorts/7oWC0CNA6kI?si=KFYLEdGFCPuGKbfY",
    description: "Una estrategia imposible de defender en Bedwars.",
    date: "2026-07-09",
    gameVersion: "1.21",
    downloads: [],
  },
  ...
  {
    id: "shader-bedrock-001",
    section: "descarga",
    title: "NovaGlow Shader",
    tag: "shader",
    tagLabel: "Shaders",
    thumbnail: "assets/thumb-shader.png",
    videoUrl: "#",
    description: "Shader de Bedrock con iluminación mejorada y efectos visuales únicos.",
    date: "2026-08-21",
    gameVersion: "1.21",
    downloads: [
      { label: "Descargar shader", url: "https://lootdest.org/s?BXwImKz5" },
    ],
  },
  {
    id: "addon-bedrock-002",
    section: "descarga",
    title: "Rise and Survive - City",
    tag: "addon",
    tagLabel: "Bedrock / Addon",
    thumbnail: "assets/thumb-addon.png",
    videoUrl: "#",
    description: "Addon de supervivencia en la ciudad con nuevas mecánicas y construcciones.",
    date: "2026-08-21",
    gameVersion: "1.21",
    downloads: [
      { label: "Descargar addon", url: "https://loot-link.com/s?FAv7hurJ" },
    ],
  },
  {
    id: "addon-bedrock-003",
    section: "descarga",
    title: "PVP 1.8 en Bedrock",
    tag: "addon",
    tagLabel: "Bedrock / Addon",
    thumbnail: "assets/thumb-addon.png",
    videoUrl: "#",
    description: "Addon que adapta la mecánica de PVP clásica de Java 1.8 a Bedrock.",
    date: "2026-08-21",
    gameVersion: "1.21",
    downloads: [
      { label: "Descargar addon", url: "https://lootdest.org/s?glnZe5pb" },
    ],
  },
  {
    id: "addon-bedrock-004",
    section: "descarga",
    title: "AplokGuns",
    tag: "addon",
    tagLabel: "Bedrock / Addon",
    thumbnail: "assets/thumb-addon.png",
    videoUrl: "#",
    description: "Addon con una variedad de armas y herramientas de combate personalizadas.",
    date: "2026-08-21",
    gameVersion: "1.21",
    downloads: [
      { label: "Descargar addon", url: "https://lootdest.org/s?R9QRD2Mw" },
    ],
  },
];
